...
- (UIImage *)imageWithFixedOrientation {
    ...
    // We do it in 2 steps: Rotate it Left/Right/Down, and then flip it Mirrored.
    ...
    // Now we draw the underluing CGImage into a new context, applying the transfrom calculated above.
    ...
    // Create a new UIImage form the drawing context
...
- (UIImage *)imageByScalingToSize:(CGSize)size andCroppingWithRect:(CGRect)rect {
    ...
    transformedImage = [self imageWithFixedOrientation];
    transformedImage = [transformedImage imageResizedToMatchAspectRatioOfSize:size];
    transformedImage = [transformedImage imageCroppedToRect:rect];
